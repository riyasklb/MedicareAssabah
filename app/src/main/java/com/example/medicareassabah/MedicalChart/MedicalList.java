...
public class MedicalList extends AppCompatActivity {
    private String url = Config.baseURL+"medicalist.php";
    String username;
...
String ekey;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HashMap<String, String> user = new SessionManager(MedicalList.this).getUserDetails();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                           // Toast.makeText(MedicalList.this, url, Toast.LENGTH_SHORT).show();
//                            Toast.makeText(MedicalList.this, response, Toast.LENGTH_SHORT).show();
