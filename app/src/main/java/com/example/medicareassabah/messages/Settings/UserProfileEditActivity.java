...
//            SweetToast.warning(this, "Sorry! your mobile number is too short");
            ...
            Toast.makeText(this, "Your status cannot be empty", Toast.LENGTH_SHORT).show();
...
//                            Toast.makeText(UserProfileEditActivity.this, "Profile Photo Error: \" + task.getException().getMessage()", Toast.LENGTH_SHORT).show();
...
//                                public Task<Uri> then(@NonNull Task<UploadTask.TaskSnapshot> task){
//                                    if (!task.isSuccessful()){
//                                        Toast.makeText(UserProfileEditActivity.this, "Thumb Image Error: \" + task.getException().getMessage()", Toast.LENGTH_SHORT).show();
